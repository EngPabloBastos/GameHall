const jogos = [
  {
    id: 1, nome: "The Legend of Zelda: Ocarina of Time", ano: 1998, plataforma: "Nintendo 64", hallScore: 100, imagem: "assets/games-img/zelda-oot.png",
  ...
  {
    id: 2, nome: "Chrono Trigger", ano: 1995, plataforma: "Super Nintendo", hallScore: 100, imagem: "assets/games-img/chrono-trigger.png",
...
=======
  {
    id: 3, nome: "Red Dead Redemption 2", ano: 2018, plataforma: "PC / PS4 / Xbox One", hallScore: 100, imagem: "assets/games-img/rdr2.png",
    sobre: "A experiência mais imersiva já feita em um mundo aberto. Cada detalhe parece vivo, desde os NPCs até a fauna e os eventos aleatórios. Arthur Morgan protagoniza uma das melhores histórias dos videogames, tornando Red Dead Redemption 2 um marco da indústria."
  },

  {
    id: 4, nome: "The Legend of Zelda: Twilight Princess", ano: 2006, plataforma: "GameCube / Wii", hallScore: 99, imagem: "assets/games-img/zelda-twilight.png",
...
>>>>>>> Stashed changes:js/jogos.js

  {
    id: 5, nome: "Resident Evil 4", ano: 2005, plataforma: "GameCube / PS2", hallScore: 99, imagem: "assets/games-img/re4.jpg",
...
=======
  {
    id: 6, nome: "Resident Evil 2", ano: 1998, plataforma: "PlayStation", hallScore: 99, imagem: "assets/games-img/re2.png",
    sobre: "Pegou a fórmula do primeiro Resident Evil e elevou tudo de nível. Dois protagonistas, campanhas complementares, ambientação memorável e uma das experiências mais marcantes do gênero survival horror."
  },

  {
    id: 7, nome: "Hollow Knight", ano: 2017, plataforma: "PC / Switch / PS4 / Xbox One", hallScore: 98, imagem: "assets/games-img/hollow_knight.jpg",
  ...
  {
    id: 8, nome: "God of War", ano: 2018, plataforma: "PC / PS4 / PS5", hallScore: 98, imagem: "assets/games-img/gow.png",
  ...
  {
    id: 9, nome: "Final Fantasy VII", ano: 1997, plataforma: "PlayStation", hallScore: 98, imagem: "assets/games-img/ff7.png",
    sobre: "O JRPG que conquistou o mundo. Cloud, Sephiroth e Aerith se tornaram ícones da cultura gamer, enquanto sua história emocionante e sua trilha sonora transformaram Final Fantasy VII em uma verdadeira lenda."
  },

  {
    id: 10, nome: "Resident Evil 4 Remake", ano: 2023, plataforma: "PC / PS4 / PS5 / Xbox Series", hallScore: 97, imagem: "assets/games-img/re4remake.png",
    sobre: "Pegou tudo que fazia o original ser incrível e conseguiu melhorar ainda mais. Refinou a gameplay, aprofundou a história, modernizou os controles e praticamente não fez cortes desnecessários. Um exemplo perfeito de como um remake deve ser feito."
  },

  {
    id: 11, nome: "Bloodborne", ano: 2015, plataforma: "PlayStation 4", hallScore: 97, imagem: "assets/games-img/bloodborne.jpg",
  ...
  {
    id: 12, nome: "Castlevania: Symphony of the Night", ano: 1997, plataforma: "PlayStation", hallScore: 96, imagem: "assets/games-img/symphony.png",
    sobre: "Uma obra-prima que redefiniu completamente Castlevania. Exploração não linear, progressão viciante, trilha sonora impecável e um dos mapas mais memoráveis da história fizeram nascer o gênero Metroidvania."
  },

  {
    id: 13, nome: "Minecraft", ano: 2011, plataforma: "Multiplataforma", hallScore: 96, imagem: "assets/games-img/minecraft.jpg",
  ...
  {
    id: 14, nome: "Grand Theft Auto: San Andreas", ano: 2004, plataforma: "PS2 / PC / Xbox", hallScore: 96, imagem: "assets/games-img/gta-sa.png",
    sobre: "É difícil acreditar que tudo isso rodava em um PlayStation 2. Um mundo aberto gigantesco, dezenas de atividades, personalização, uma história marcante e liberdade como poucos jogos ofereceram até hoje."
  },

  {
    id: 15, nome: "Grand Theft Auto V", ano: 2013, plataforma: "PC / PS3 / PS4 / PS5 / Xbox", hallScore: 96, imagem: "assets/games-img/gta5.jpg",
    sobre: "Um dos maiores sucessos da história dos games. Los Santos continua impressionando mais de uma década depois, seja pela liberdade, pelos três protagonistas ou pela quantidade absurda de conteúdo disponível."
  },

  {
    id: 16, nome: "Super Mario World", ano: 1990, plataforma: "Super Nintendo", hallScore: 95, imagem: "assets/games-img/smw.png",
    sobre: "O melhor jogo de plataforma já feito. Controles perfeitos, fases criativas, arte atemporal e uma trilha sonora inesquecível. Um clássico da época em que a Nintendo parecia simplesmente não errar."
  },

  {
    id: 17, nome: "Baldur's Gate 3", ano: 2023, plataforma: "PC / PS5 / Xbox Series", hallScore: 95, imagem: "assets/games-img/baldurs-gate.png",
  ...
  {
    id: 18, nome: "Silent Hill 2", ano: 2001, plataforma: "PlayStation 2", hallScore: 95, imagem: "assets/games-img/silent2.jpg",
  ...
  {
    id: 19, nome: "Elden Ring", ano: 2022, plataforma: "PC / PS4 / PS5 / Xbox", hallScore: 95, imagem: "assets/games-img/elden-ring.jpg",
  ...
  {
    id: 20, nome: "Need for Speed: Most Wanted", ano: 2005, plataforma: "PC / PS2 / Xbox / GameCube", hallScore: 94, imagem: "assets/games-img/nfs.png",
    sobre: "O auge da franquia Need for Speed. A mistura de perseguições policiais, carros lendários, sensação de velocidade e uma trilha sonora recheada de rock e metal faz desse o melhor jogo de corrida arcade de todos os tempos."
  },
>>>>>>> Stashed changes:js/jogos.js
];